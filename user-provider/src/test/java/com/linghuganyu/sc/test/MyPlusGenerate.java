package com.linghuganyu.sc.test;
...
public class MyPlusGenerate {
    ...
    public static void main(String[] args) {
        ...
        gc.setAuthor("lh");
        //设置输出的路径
        gc.setOutputDir(System.getProperty("user.dir")+"/user-provider/src/main/java");
        //设置输出是否打开
        gc.setOpen(false);
        //设置生成返回的map结果集
        ...
        //数据库的连接地址
        ds.setUrl("jdbc:mysql://localhost:3306/mall?characterEncoding=UTF-8&useSSL=false&serverTimezone=GMT%2B8");
        //数据库用户名
        ds.setUsername("root");
        //数据库密码
        ds.setPassword("root");
